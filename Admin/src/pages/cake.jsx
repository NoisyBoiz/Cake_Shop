...
import { getAllCakes, deleteCake } from "../services/cake";
...
function Cake(){ 
    ...
    useEffect(()=>{
        getAllCakes().then(rs=>{
            let data = rs.data.data.sort((a,b)=>a.id-b.id);
            setAllData(data);
        ...
        deleteCake(id).then(rs=>{
            if(rs.status===200){
                ...
                notification.success({
                    title:"Xóa bánh",
                    message:"Xóa bánh thành công!"
                });
            }
            else{
                notification.error({
                    title:"Xóa bánh",
                    message:"Xóa bánh thất bại!"
                });
            }
        });
    }
    ...
    return(
        <div className="list-content">
                ...
                <> 
                    <div className="list-container">
                        <div className="list-table">  
                            <ul className="list-header list-header-cake"> 
                                <li> Id </li>
                                <li> Danh mục </li>
                                <li> Tên </li>
                                <li> Mô tả </li>
                                <li className="header-list-cake-size"> <span> Kích thước </span> <span> Giá </span> <span> Giá gốc </span></li>
                                <li> Hình ảnh </li>
                                <li> Sửa </li>
                                <li> Xóa </li>
                            </ul>
            ...
            <Link to="/cakeForm/-1" className="add-data"> + </Link>
        </div>
    );
}
