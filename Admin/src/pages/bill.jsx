...
import { getAllBills, deleteBill } from "../services/bill.js";
...
function Bill(){ 
    ...
    return(
        <div className="list-content">
                ...
                <> 
                    <div className="list-container">
                        <div className="list-table">  
                            <ul className="list-header list-header-bill"> 
                                <li> Id </li>
                                <li> Id Client </li>
                                <li> Lưu ý </li>
            ...
            <Link to="/billForm/-1" className="add-data"> + </Link>
        </div>
    );
}
