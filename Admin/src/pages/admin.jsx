...
import { getAllAdmins, deleteAdmin } from "../services/admin.js";
...
function Admin(){ 
    ...
    return(
        <div className="list-content">
                ...
                <> 
                    <div className="list-container">
                        <div className="list-table">  
                            <ul className="list-header list-header-admin"> 
                                <li> Id </li>
                                <li> Tên </li>
                                <li> Email </li>
                                <li> Mật khẩu </li>
            ...
            <Link to="/adminForm/-1" className="add-data"> + </Link>
        </div>
    );
}
