...
import { getAllClients,deleteClient } from "../services/client.js";
...
function Client(){ 
        ...
        deleteClient(id).then(rs=>{
            if(rs.status===200){
                ...
                notification.success({
                    ...
                    message:"Xóa người dùng Success"
                });
            }
            else{
                notification.error({
    ...
    return(
        <div className="list-content">
                ...
                <> 
                    <div className="list-container">
                        <div className="list-table">  
                            <ul className="list-header list-header-client"> 
                                <li> Id </li>
                                <li> Tên </li>
                                <li> Điện thoại </li>
                                <li> Địa chỉ </li>
                            ...
                            {dataSlice.map((item,index)=>{
                                return(
                                    <ul key={index} className="list-row list-row-client"> 
                                        <li> {item.id} </li>
                                        <li> {item.name} </li>
            ...
            <Link to="/clientForm/-1" className="add-data"> + </Link>
        </div>
    );
}
